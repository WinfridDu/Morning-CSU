...
import com.csuylg.common.annotation.Excels;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public Map<String, Object> exportExcel(List<T> list, String sheetName) throws Exception {
    ...
    public Map<String, Object> exportExcel() throws Exception {
        ...
        try {
            ...
            map.put("msg", FileUploadUtils.RESOURCE_PREFIX + "/download/" + filename);
            return map;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = MorningConfig.getDownloadPath() + filename;
